<div class="page-home">
    <h1>Miks — Енциклопедія аніме та манги</h1>
    <p class="page-home__subtitle">Лабораторна робота №5 — Варіант 14</p>
    <p class="text-muted">Каталог аніме та манги з коментарями, рейтинговими записами і ролями користувачів (user/admin).</p>
