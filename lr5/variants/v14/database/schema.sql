...
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Adventure','Пригоди','Adventure','Подорожі, дослідження нових світів та пошук пригод','#f59e0b','compass');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Comedy','Комедія','Comedy','Смішні ситуації, жарти та гумористичні діалоги','#10b981','laugh');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Drama','Драма','Drama','Емоційні історії з глибоким психологічним підтекстом','#8b5cf6','drama');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Fantasy','Фентезі','Fantasy','Магія, фантастичні істоти та вигадані світи','#ec4899','magic');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Sci-Fi','Наукова фантастика','Sci-Fi','Футуристичні технології, космос та наукові відкриття','#3b82f6','robot');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Romance','Романтика','Romance','Історії кохання та романтичні стосунки','#ff6b6b','heart');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Slice of Life','Повсякденність','Slice of Life','Звичайне життя, щоденні турботи та побут','#a3e635','home');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Mystery','Містика','Mystery','Таємничі події, розслідування та нерозгадані загадки','#6366f1','question');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Horror','Жахи','Horror','Страшні історії, що викликають почуття страху та тривоги','#18181b','ghost');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Psychological','Психологічний','Psychological','Глибокий аналіз психіки персонажів та їхніх мотивів','#7c3aed','brain');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Supernatural','Надприродне','Supernatural','Надприродні сили, духи, демони та паранормальні явища','#c084fc','sparkles');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Sports','Спорт','Sports','Спортивні змагання, тренування та командний дух','#22c55e','sports');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Music','Музика','Music','Історії про музику, музикантів та музичні гурти','#f43f5e','music');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('School','Школа','School','Шкільне життя, навчання та стосунки між учнями','#eab308','school');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Shounen','Шьонен','Shounen','Для хлопчиків-підлітків: битви, дружба, пригоди','#f97316','target');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Seinen','Сейнен','Seinen','Для дорослих чоловіків: серйозні теми, складні сюжети','#6b7280','mature');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Isekai','Ісекай','Isekai','Перенесення в інший світ, переродження','#a855f7','portal');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Mecha','Меха','Mecha','Гігантські роботи та пілотування','#64748b','robot');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Historical','Історичний','Historical','Історичні події та епохи','#b45309','history');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Military','Військовий','Military','Військові конфлікти, армія, стратегія','#475569','military');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Crime','Кримінал','Crime','Злочинний світ, розслідування, мафія','#1e293b','crime');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Thriller','Трилер','Thriller','Напружені історії, що тримають у постійній напрузі','#292524','thriller');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Gourmet','Кулінарія','Gourmet','Про їжу, приготування та кулінарне мистецтво','#fbbf24','food');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Harem','Гарем','Harem','Один головний герой та багато героїнь','#f87171','harem');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Martial Arts','Бойові мистецтва','Martial Arts','Різні види бойових мистецтв та поєдинків','#dc2626','fist');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Philosophical','Філософський','Philosophical','Філософські роздуми про життя, смерть, сенс буття','#4f46e5','philosophy');
INSERT OR IGNORE INTO genre (Name,NameUA,NameEN,Description,Color,Icon) VALUES ('Space','Космос','Space','Космічні подорожі, міжпланетні війни','#0f172a','rocket');
INSERT OR IGNORE INTO anime (Title,TitleUA,Year,Season,Episodes,EpisodeDuration,Type,Status,Source,RatingMPAA,Description,DescriptionUA,StudioID,CoverUrl,Views,Favorites) VALUES ('Frieren: Beyond Journey''s End','Проводжальниця Фрірен',2023,'Fall',28,25,'TV','Ongoing','Manga','PG-13','The story follows the elf mage Frieren...','​Короля демонів переможено, і загін героїв-переможців повертається додому перед тим, як розійтися по домівках. Чотири героя — Фрірен, герой Гіммель, священник Гайтер і воїн Айзен — згадують про свою десятирічну подорож, коли настає момент прощання. Але для ельфів плин часу є іншим, тож Фрірен стає свідком того, як її супутники повільно відходять у вічність один за одним. Перед смертю Гайтер встигає навязати Фрірен молоду людську ученицю на імя Ферн. Захоплені пристрастю ельфійки до колекціонування безлічі магічних заклинань, вони вирушають у, здавалося б, безцільну мандрівку, відвідуючи місця, де побували герої минулого. Під час мандрівки Фрірен поступово усвідомлює, що шкодує про втрачені можливості налагодити глибші звязки зі своїми нині покійними товаришами.',4,'https://cdn.myanimelist.net/images/anime/1015/138006.jpg',150000,25000);
...
INSERT OR IGNORE INTO author (Name,NameUA,NameEN,BirthDate,BirthPlace,Gender,Biography,ImageUrl) VALUES ('Kentaro Miura','Кентаро Міура','Kentaro Miura','1966-07-11','Chiba, Japan','Male','Kentaro Miura was a Japanese manga artist, best known for his dark fantasy series Berserk.','https://cdn.myanimelist.net/images/voiceactors/3/61071.jpg');
INSERT OR IGNORE INTO author (Name,NameUA,NameEN,BirthDate,BirthPlace,Gender,Biography,ImageUrl) VALUES ('Takehiko Inoue','Такехіко Іноуе','Takehiko Inoue','1967-01-12','Okuchi, Japan','Male','Takehiko Inoue is a Japanese manga artist, best known for creating Slam Dunk, Vagabond, and Real.','https://cdn.myanimelist.net/images/voiceactors/2/54829.jpg');
INSERT OR IGNORE INTO author (Name,NameUA,NameEN,BirthDate,BirthPlace,Gender,Biography,ImageUrl) VALUES ('ONE','ONE','ONE','1986-10-29','Niigata, Japan','Male','ONE is a Japanese manga artist, best known for his webcomics One Punch Man and Mob Psycho 100.','https://cdn.myanimelist.net/images/voiceactors/2/55863.jpg');
INSERT OR IGNORE INTO author (Name,NameUA,NameEN,BirthDate,BirthPlace,Gender,Biography,ImageUrl) VALUES ('Tatsuki Fujimoto','Тацукі Фудзімото','Tatsuki Fujimoto','1992-10-10','Akita, Japan','Male','Tatsuki Fujimoto is a Japanese manga artist, best known for creating Chainsaw Man and Fire Punch.','https://cdn.myanimelist.net/images/voiceactors/3/66441.jpg');
INSERT OR IGNORE INTO author (Name,NameUA,NameEN,BirthDate,BirthPlace,Gender,Biography,ImageUrl) VALUES ('Chugong','Чуґон','Chugong','1985-01-01','South Korea','Male','Chugong is a South Korean author, best known for writing the web novel Solo Leveling.','https://cdn.pixabay.com/photo/2016/03/31/20/27/avatar-1295770_1280.png');
INSERT OR IGNORE INTO users (Login,Email,DisplayName,Role,Bio,AvatarUrl) VALUES ('admin','admin@miks.ua','Адміністратор','admin','Головний адміністратор сайту. Люблю аніме та мангу, особливо філософські твори.','https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_1280.png');
INSERT OR IGNORE INTO users (Login,Email,DisplayName,Role,Bio,AvatarUrl) VALUES ('animefan','fan@example.com','Аніме Фан','user','Дивлюсь аніме щодня. Люблю бойовики та пригоди. Мої улюблені: Jujutsu Kaisen, One Piece.','https://cdn.pixabay.com/photo/2016/03/31/20/27/avatar-1295773_1280.png');
INSERT OR IGNORE INTO users (Login,Email,DisplayName,Role,Bio,AvatarUrl) VALUES ('mangalover','manga@example.com','Манга Любитель','user','Колекціоную мангу вже 10 років. Особливо люблю сейнен та історичні твори. Berserk - найкраще, що я читав.','https://cdn.pixabay.com/photo/2016/03/31/20/31/avatar-1295775_1280.png');
INSERT OR IGNORE INTO users (Login,Email,DisplayName,Role,Bio,AvatarUrl) VALUES ('reviewer','review@example.com','Оглядач','user','Пишу огляди на новинки аніме. Намагаюсь бути об''єктивним та допомагати іншим обирати що подивитись.','https://cdn.pixabay.com/photo/2016/03/31/20/27/avatar-1295770_1280.png');
INSERT OR IGNORE INTO users (Login,Email,DisplayName,Role,Bio,AvatarUrl) VALUES ('moderator','mod@example.com','Модератор','moderator','Слідкую за порядком на сайті. Люблю коли все структуровано та правильно.','https://cdn.pixabay.com/photo/2016/03/31/20/27/avatar-1295772_1280.png');
INSERT OR IGNORE INTO users (Login,Email,DisplayName,Role,Bio,AvatarUrl) VALUES ('sakurafan','sakura@example.com','Сакура Фан','user','Люблю романтику та повсякденність. Мої улюблені: Your Lie in April, Horimiya.','https://cdn.pixabay.com/photo/2016/04/01/12/11/avatar-1300582_1280.png');
INSERT OR IGNORE INTO users (Login,Email,DisplayName,Role,Bio,AvatarUrl) VALUES ('darkness','dark@example.com','Темний Лицар','user','Полюбляю темне фентезі та психологічні трилери. Berserk, Monster, Death Note - мої фаворити.','https://cdn.pixabay.com/photo/2016/04/01/12/11/avatar-1300585_1280.png');
INSERT OR IGNORE INTO users (Login,Email,DisplayName,Role,Bio,AvatarUrl) VALUES ('newbie','new@example.com','Новачок','user','Тільки починаю знайомство з аніме. Допоможіть з рекомендаціями!','https://cdn.pixabay.com/photo/2016/04/01/12/11/avatar-1300583_1280.png');
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (1,1,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (1,2,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (1,3,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (2,4,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (2,5,'Supporting',0);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (3,6,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (3,7,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (4,8,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (4,9,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (4,10,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (4,11,'Antagonist',0);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (5,8,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (5,9,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (5,10,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (5,11,'Antagonist',0);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (9,8,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (9,9,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (9,10,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (9,11,'Antagonist',0);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (10,12,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (11,13,'Main',1);
INSERT OR IGNORE INTO animecharacter (AnimeID,CharacterID,Role,IsMain) VALUES (11,14,'Main',1);
INSERT OR IGNORE INTO mangacharacter (MangaID,CharacterID,Role,IsMain) VALUES (1,1,'Main',1);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (1,1,9.5,1,'Completed',28);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (1,2,9.0,1,'Completed',28);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (1,3,9.8,1,'Completed',28);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (1,4,9.2,1,'Completed',28);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (2,1,9.0,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (2,2,9.5,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (2,3,8.5,0,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (2,5,9.3,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (3,1,10.0,1,'Completed',88);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (3,2,9.8,1,'Completed',88);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (3,3,9.5,1,'Completed',88);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (3,6,9.7,1,'Completed',88);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (4,2,9.5,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (4,3,9.0,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (4,7,8.8,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (5,2,9.9,1,'Completed',26);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (5,3,9.7,1,'Completed',26);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (5,4,9.5,1,'Completed',26);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (6,2,9.8,1,'Completed',64);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (6,3,9.7,1,'Completed',64);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (6,5,9.6,1,'Completed',64);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (7,2,8.5,0,'Completed',13);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (7,3,9.0,1,'Completed',13);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (8,1,9.5,1,'Watching',500);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (8,2,9.0,1,'Watching',300);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (8,6,9.2,1,'Watching',250);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (9,1,9.0,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (9,2,9.2,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (9,3,8.8,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (9,7,9.1,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (10,1,9.2,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (10,2,9.5,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (10,3,9.0,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (10,4,9.3,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (11,1,8.5,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (11,2,9.0,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (11,5,8.8,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (12,1,8.7,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (12,2,9.1,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (13,1,9.3,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (13,2,9.6,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (13,6,9.4,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (14,1,9.1,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (14,2,9.4,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (15,1,8.9,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (15,2,9.2,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (15,7,9.0,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (16,1,9.0,1,'Completed',22);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (16,2,9.5,1,'Completed',22);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (17,1,8.8,1,'Completed',11);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (17,2,9.0,1,'Completed',11);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (18,1,8.5,1,'Completed',13);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (18,2,8.9,1,'Completed',13);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (19,1,8.7,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (19,2,9.0,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (20,1,8.2,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (20,2,8.5,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (20,3,8.0,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (21,1,8.9,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (21,2,9.2,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (22,1,8.6,1,'Completed',23);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (22,2,9.0,1,'Completed',23);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (23,1,9.2,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (23,2,9.5,1,'Completed',12);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (24,1,9.4,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (24,2,9.7,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (25,1,9.1,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (25,2,9.3,1,'Completed',24);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (26,1,9.3,1,'Completed',10);
INSERT OR IGNORE INTO rating (AnimeID,UserID,Score,IsFavorite,Status,Progress) VALUES (26,2,9.6,1,'Completed',10);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (1,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (1,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (1,5);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (1,8);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (1,27);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (2,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (2,5);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (2,11);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (2,12);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (2,16);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (3,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (3,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (3,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (3,21);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (3,27);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (4,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (4,3);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (4,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (4,8);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (4,7);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (5,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (5,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (5,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (5,5);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (5,16);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (6,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (6,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (6,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (6,5);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (6,27);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (7,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (7,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (7,3);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (7,13);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (7,15);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (8,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (8,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (8,3);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (8,5);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (8,16);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (9,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (9,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (9,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (9,5);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (9,10);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (10,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (10,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (10,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (10,5);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (10,18);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (11,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (11,3);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (11,5);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (11,9);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (11,7);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (12,13);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (12,15);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (12,16);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (13,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (13,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (13,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (13,20);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (14,3);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (14,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (14,7);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (14,15);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (15,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (15,3);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (15,11);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (15,12);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (16,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (16,7);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (16,14);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (16,15);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (17,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (17,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (17,6);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (17,21);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (18,3);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (18,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (18,7);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (18,15);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (19,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (19,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (19,6);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (19,15);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (20,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (20,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (20,9);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (20,10);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (20,11);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (21,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (21,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (21,6);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (21,9);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (21,11);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (22,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (22,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (22,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (22,6);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (22,28);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (23,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (23,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (23,6);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (23,9);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (23,11);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (24,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (24,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (24,3);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (24,20);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (25,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (25,2);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (25,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (25,6);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (25,19);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (26,1);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (26,4);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (26,6);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (26,11);
INSERT OR IGNORE INTO animegenre (AnimeID,GenreID) VALUES (26,23);
...
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (1,1,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (1,2,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (1,3,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (2,4,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (2,5,'Supporting',0);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (3,6,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (3,7,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (4,8,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (4,9,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (4,10,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (4,11,'Antagonist',0);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (5,8,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (5,9,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (5,10,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (5,11,'Antagonist',0);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (9,8,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (9,9,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (9,10,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (9,11,'Antagonist',0);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (10,12,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (11,13,'Main',1);
INSERT OR IGNORE INTO animecharacter (anime_id,character_id,role,is_main) VALUES (11,14,'Main',1);
INSERT OR IGNORE INTO mangacharacter (manga_id,character_id,role,is_main) VALUES (1,1,'Main',1);
...
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (1,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (1,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (1,5);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (1,8);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (1,27);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (2,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (2,5);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (2,11);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (2,12);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (2,16);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (3,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (3,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (3,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (3,21);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (3,27);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (4,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (4,3);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (4,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (4,8);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (4,7);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (5,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (5,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (5,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (5,5);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (5,16);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (6,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (6,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (6,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (6,5);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (6,27);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (7,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (7,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (7,3);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (7,13);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (7,15);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (8,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (8,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (8,3);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (8,5);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (8,16);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (9,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (9,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (9,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (9,5);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (9,10);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (10,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (10,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (10,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (10,5);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (10,18);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (11,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (11,3);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (11,5);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (11,9);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (11,7);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (12,13);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (12,15);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (12,16);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (13,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (13,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (13,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (13,20);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (14,3);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (14,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (14,7);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (14,15);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (15,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (15,3);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (15,11);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (15,12);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (16,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (16,7);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (16,14);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (16,15);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (17,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (17,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (17,6);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (17,21);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (18,3);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (18,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (18,7);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (18,15);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (19,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (19,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (19,6);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (19,15);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (20,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (20,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (20,9);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (20,10);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (20,11);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (21,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (21,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (21,6);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (21,9);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (21,11);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (22,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (22,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (22,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (22,6);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (22,28);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (23,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (23,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (23,6);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (23,9);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (23,11);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (24,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (24,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (24,3);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (24,20);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (25,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (25,2);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (25,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (25,6);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (25,19);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (26,1);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (26,4);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (26,6);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (26,11);
INSERT OR IGNORE INTO animegenre (anime_id,genre_id) VALUES (26,23);
